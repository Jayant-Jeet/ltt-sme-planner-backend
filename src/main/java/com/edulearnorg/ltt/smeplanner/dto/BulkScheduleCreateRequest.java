...
public class BulkScheduleCreateRequest {
    ...
    // Constructors
    public BulkScheduleCreateRequest() {}
    
    public BulkScheduleCreateRequest(List<CreateScheduleRequest> schedules) {
        this.schedules = schedules;
    }
    
    public BulkScheduleCreateRequest(List<CreateScheduleRequest> schedules, boolean skipConflicts) {
        this.schedules = schedules;
    ...
    public String toString() {
        return "BulkScheduleCreateRequest{" +
                "schedules=" + schedules +
